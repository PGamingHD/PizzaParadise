...
CREATE TABLE `userblacklists` (
  ...
  PRIMARY KEY (`userId`),
  UNIQUE KEY `iduserblacklists_UNIQUE` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `userblacklists`
--

LOCK TABLES `userblacklists` WRITE;
/*!40000 ALTER TABLE `userblacklists` DISABLE KEYS */;
/*!40000 ALTER TABLE `userblacklists` ENABLE KEYS */;
UNLOCK TABLES;
