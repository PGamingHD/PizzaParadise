...
CREATE TABLE `cryptowallet` (
  ...
  `hasCryptoWallet` tinyint NOT NULL DEFAULT '0',
  `cryptoBitcoin` double NOT NULL DEFAULT '0',
  `cryptoEthereum` double NOT NULL DEFAULT '0',
  `cryptoLitecoin` double NOT NULL DEFAULT '0',
